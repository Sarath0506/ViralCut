...
const SIGNUP_FEATURES: {
  ...
  },
  {
    ...
    description:
      "Full control over every creative asset. Approve, request edits, or reject submissions across all client brand workspaces.",
  },
  {
    icon: Users,
      ...
      <AuthHeroShell
        footer={
          <p className={authHeroFooterClass}>
            Trusted by agencies managing 500+ brand campaigns
          </p>
        }
      >
        <HeroCopyBlock>
          <h1 className={authHeroTitleClass}>
            Run campaigns for every brand you manage.
          </h1>
      ...
      <HeroCopyBlock>
        <div className="shrink-0">
          <h1 className={authHeroTitleClass}>
            One portal.
            <br />
            <span className="text-violet-200">All your brands.</span>
          </h1>
          <p className={authHeroBodyClass}>
            Create brand workspaces, launch creator campaigns, and review
            submissions on behalf of your clients — with each brand scoped to
            its own wallet and data.
          </p>
        </div>
